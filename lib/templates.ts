...
export function getNormalCardSvg(
  styleId: string,
  form: { eventType: string; names: string; date: string; venue: string; wishingOn?: string }
): string {
  ...
  return rawSvg.replace(
    '</svg>',
    '<text x="50%" y="1165" text-anchor="middle" fill="#ffffff" fill-opacity="0.35" font-family="\'Outfit\', sans-serif" font-size="12" font-weight="700" letter-spacing="4">PROVED BY ADITYA DWIVEDI</text></svg>'
  );
}
...
function getNormalCardSvgBase(
  ...
  const event = (form.wishingOn || form.eventType).toUpperCase();
    ...
    case 'royal_gold':
      return `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1200" width="100%" height="100%">
          ...
          <g transform="translate(400, 310) scale(1.8)" stroke="#D4AF37" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path d="M -15 -10 Q 0 -35 15 -10 C 20 0 10 20 0 25 C -10 20 -20 0 -15 -10 Z"/>
            <path d="M 0 -15 Q -10 -5 -5 10 Q 0 35 15 15"/>
            <circle cx="-6" cy="-15" r="2.5" fill="#D4AF37"/>
            <circle cx="6" cy="-15" r="2.5" fill="#D4AF37"/>
            <path d="M -25 -5 Q -35 -10 -28 -25 Q -15 -25 -15 -10"/>
            <path d="M 25 -5 Q 35 -10 28 -25 Q 15 -25 15 -10"/>
            <path d="M -15 -35 L 0 -55 L 15 -35 Z" fill="#D4AF37" fill-opacity="0.8"/>
            <circle cx="0" cy="-55" r="3" fill="#D4AF37"/>
          </g>
    ...
    case 'griha_pravesh':
      return `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1200" width="100%" height="100%">
          ...
          <g transform="translate(400, 370) scale(1.6)" stroke="#D4AF37" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path d="M -15 -10 Q 0 -35 15 -10 C 20 0 10 20 0 25 C -10 20 -20 0 -15 -10 Z"/>
            <path d="M 0 -15 Q -10 -5 -5 10 Q 0 35 15 15"/>
            <circle cx="-6" cy="-15" r="2.5" fill="#D4AF37"/>
            <circle cx="6" cy="-15" r="2.5" fill="#D4AF37"/>
    ...
    case 'marigold_swastik':
      return `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1200" width="100%" height="100%">
          ...
          <g transform="translate(400, 240) scale(1.6)" stroke="#D4AF37" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path d="M -15 -10 Q 0 -35 15 -10 C 20 0 10 20 0 25 C -10 20 -20 0 -15 -10 Z"/>
            <path d="M 0 -15 Q -10 -5 -5 10 Q 0 35 15 15"/>
            <circle cx="-6" cy="-15" r="2.5" fill="#D4AF37"/>
            <circle cx="6" cy="-15" r="2.5" fill="#D4AF37"/>
    ...
    case 'traditional_hindu_wedding':
      return `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1200" width="100%" height="100%">
          ...
          <g transform="translate(400, 240) scale(1.8)" stroke="#D4AF37" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path d="M -15 -10 Q 0 -35 15 -10 C 20 0 10 20 0 25 C -10 20 -20 0 -15 -10 Z"/>
            <path d="M 0 -15 Q -10 -5 -5 10 Q 0 35 15 15"/>
            <circle cx="-6" cy="-15" r="2.5" fill="#D4AF37"/>
            <circle cx="6" cy="-15" r="2.5" fill="#D4AF37"/>
